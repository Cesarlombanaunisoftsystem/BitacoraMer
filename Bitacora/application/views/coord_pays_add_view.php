                                    ...
                                    if (isset($paysAdd) && $paysAdd) {
                                        foreach ($paysAdd as $row) {
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="number" name="percent" id="percent_<?= $row->id ?>" class="form form-control" min="1" max="100" onchange="assignPercent(this.value,<?= $row->id ?>)">
                                                </td>
                                            </tr>
                                            <?php
                                        }
...
<script type="text/javascript">
    ...
    cargar_menu("coordinacion_pay", 'Pagos adicionales');
