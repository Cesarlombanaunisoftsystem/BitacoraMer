<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
                                                    ...
                                                    foreach ($pl as $row) {
                                                        ...
                                                        <tr style="background-color:<?= $trcolor ?>">
                                                            ...
                                                            <td><?php
                                                                ...
                                                                echo round($util, 2) . ' %';
                                                                ?></td>
                                                            <td><a href="#" onclick="assign(<?= $row->id . "," . $row->idTechnicals ?>)">
                                                                    <i class="fa fa-check-square" style="color: green"></i>
                                                                </a>
                                                                <a href="#" onclick="return_order(<?= $row->id ?>)">
        ...
        <script type="text/javascript">
            ...
            function assign(idOrder, idTech) {
                $.confirm({
                    ...
                    buttons: {
                        confirmar: function () {
                            ...
                            $.ajax({
                                url: url,
                                type: 'POST',
                                data: {idOrder: idOrder, idArea: <?= $areaAssign ?>, idState: <?= $stateAssign ?>, idTech: idTech, stateLog: <?= $stateLog ?>},
                                success: function (resp) {
                                    if (resp === "error") {
                                        alertify.error('Error en BBDD');
                                    }
                    ...
                    buttons: {
                        confirmar: function () {
                            ...
                            $.ajax({
                                url: url,
                                type: 'POST',
                                data: {idOrder: idOrder, idArea: <?= $areaReturn ?>, idState: <?= $stateReturn ?>, stateLog: <?= $stateLog ?>},
                                success: function (resp) {
                                    if (resp === "error") {
                                        alertify.error('Error en BBDD');
                                    }
